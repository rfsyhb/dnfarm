    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-8 gap-2">
      ...
      <div className="flex flex-row items-center gap-2 w-full">
        ...
        <div className="flex flex-row gap-1">
          <button
            type="button"
            onClick={() => setDisplayTable('Main')}
            className={`${displayTable === 'Main' ? 'underline' : ''} hover:cursor-pointer`}
          >
            Main Table
          </button>
          <button
            type="button"
            onClick={() => setDisplayTable('Summary')}
            className={`${displayTable === 'Summary' ? 'underline' : ''} hover:cursor-pointer`}
          >
            Summary Table
          </button>
        </div>
